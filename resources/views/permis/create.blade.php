...
<div class="row">
            ...
            <div align="right"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Commune de Djerba Houmet Souk</font></font></div>
            ...
            <form  action="{{route('ajoutPermis')}}" method="POST" enctype="multipart/form-data" class="row g-4">
            <div class="container mt-5">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
